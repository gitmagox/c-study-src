...
int main( int argc, char* argv[] )
{
	...
	users = (client_data *)malloc((USER_LIMIT+1)*sizeof(client_data));
	memset( users,'\0',USER_LIMIT+1 );
	//sub_process = new int[ PROCESS_LIMIT ];
	sub_process = (int *)malloc((PROCESS_LIMIT)*sizeof(int));
	memset( sub_process,'\0',PROCESS_LIMIT );
