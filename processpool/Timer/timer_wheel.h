...
static inline void wheel_start(timer_wheel * timerWheel);
static inline void wheel_stop(timer_wheel * timerWheel);
static inline void wheel_tick(timer_wheel * timerWheel);
